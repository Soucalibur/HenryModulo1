...
function cacheFunction(cb) {
  // LA FUNCIÓN RETORNADA TIENE QUE RECIBIR UN PARÁMETRO.
  // TIENE QUE FIJARSE SI YA TIENE ESTE ARGUMENTO GUARDADO.
  // SI YA LO TIENE.... RETORNAR LO QUE TIENE GUARDADO EN MEMORIA
  // SI NO LO TIENE.... CALCULAR... PERO TAMBIÉN GUARDAR
  var cache = {};
...
console.log(textoAsteriscos("Jorge"));
console.log(textoGuiones("Andrés"));
console.log(textoUnderscore("Juanjo"));
